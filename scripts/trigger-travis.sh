...
# source: https://raw.githubusercontent.com/plume-lib/trigger-travis/master/trigger-travis.sh
# license: https://raw.githubusercontent.com/plume-lib/trigger-travis/master/LICENSE
